...
def position_record() -> PaperPositionRecord:
    return PaperPositionRecord(
        ...
        original_gross_cost_basis=Decimal("19.89"),
        original_entry_fees=Decimal("0.02"),
        original_total_cost_basis=Decimal("19.91"),
        ...
        latest_base_forecast_id=FORECAST_ID,
