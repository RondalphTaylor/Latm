...
def proposal_source_is_consistent(context: RiskEvaluationContext) -> bool:
    """Verify that an advisory proposal still names the exact opportunity evidence."""
...
def build_risk_evaluation_input(
    ...
    *,
    ...
    """Build the shared deterministic risk input used at review and execution."""
    proposal = context.proposal
    opportunity = context.opportunity
    ...
    return RiskEvaluationInput(
        ...
        runtime_trading_mode=runtime_trading_mode,
        ...
        active_sizing_strategy_version=active_sizing_strategy_version,
        proposal_input_fingerprint=proposal.input_fingerprint,
        opportunity_input_fingerprint=opportunity.input_fingerprint,
        proposal_source_is_consistent=proposal_source_is_consistent(context),
...
class RiskService:
    ...
    async def run(
        ...
        *,
        ...
        for selected_proposal_id in proposal_ids:
            ...
            source = build_risk_evaluation_input(
                context,
                evaluated_at=evaluated_at,
    ...
    def _evaluation_input(
        ...
        return build_risk_evaluation_input(
            context,
            evaluated_at=evaluated_at,
            runtime_trading_mode=self._runtime_trading_mode,
            active_sizing_strategy_version=self._active_sizing_strategy_version,
    ...
    def _proposal_source_is_consistent(context: RiskEvaluationContext) -> bool:
        return proposal_source_is_consistent(context)
