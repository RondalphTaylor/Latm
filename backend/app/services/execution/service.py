    ...
    def _position_record(
        *,
        ...
        return PaperPositionRecord(
            ...
            direction=risk.direction,
            status="open",
            initial_quantity=decision.executed_quantity,
            quantity=decision.executed_quantity,
            disposed_quantity=0,
            version=0,
            average_entry_price=decision.execution_price,
            original_gross_cost_basis=decision.gross_cost,
            original_entry_fees=decision.fee_amount,
            original_total_cost_basis=decision.total_cost,
            ...
            latest_base_forecast_id=risk.base_forecast_id,
            market_resolution_id=None,
            input_fingerprint=decision.input_fingerprint,
            projection_fingerprint=decision.input_fingerprint,
